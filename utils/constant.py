...
COREF_TO_ID = {
    'M_OBJ' :  {PAD_TOKEN:  0, UNK_TOKEN:  1, 'O':  2, 'PERSON':  3, 'ORGANIZATION':  4, 'LOCATION':  5, 'DATE':  6, 'NUMBER':  7, 'MISC':  8, 'DURATION':  9, 'MONEY': 10, 'PERCENT': 11, 'ORDINAL': 12, 'TIME': 13, 'SET': 14},
    'M_SUBJ':  {PAD_TOKEN: 15, UNK_TOKEN: 16, 'O': 17, 'PERSON': 18, 'ORGANIZATION': 19, 'LOCATION': 20, 'DATE': 21, 'NUMBER': 22, 'MISC': 23, 'DURATION': 24, 'MONEY': 25, 'PERCENT': 26, 'ORDINAL': 27, 'TIME': 28, 'SET': 29},
    'NO_M':    {PAD_TOKEN: 30, UNK_TOKEN: 31, 'O': 32, 'PERSON': 33, 'ORGANIZATION': 34, 'LOCATION': 35, 'DATE': 36, 'NUMBER': 37, 'MISC': 38, 'DURATION': 39, 'MONEY': 40, 'PERCENT': 41, 'ORDINAL': 42, 'TIME': 43, 'SET': 44}
}
